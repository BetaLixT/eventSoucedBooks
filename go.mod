module eventSourcedBooks

go 1.18

require (
	github.com/BetaLixT/appInsightsTrace v0.2.2
	github.com/BetaLixT/gottp v0.4.1
	github.com/BetaLixT/rmqevnter v0.2.2
	github.com/BetaLixT/tsqlx v0.2.0
	github.com/BetaLixT/usago v0.1.7
